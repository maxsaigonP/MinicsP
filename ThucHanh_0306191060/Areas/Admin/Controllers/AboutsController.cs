...
namespace ThucHanh_0306191060.Areas.Admin.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public AboutsController(ThucHanh_0306191060Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,title,description,content")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,title,description,content")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
